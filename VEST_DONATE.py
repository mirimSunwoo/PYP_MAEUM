...
class Vest_donate:
    def __init__(self, vest_donate):
        ...
        # 레이블 박스 버튼
        btn = Button(vest_donate)  # root라는 창에 버튼 생성
        ...
        # 레이블 선택되었음 대기
        school_lb = Label(vest_donate)  # root라는 창에 레이블 생성
        ...
        btn_defect1 = Radiobutton(vest_donate, text="1 ", value="약", variable=defect_lang_var)
        btn_defect1.select()  # 기본값 선택
        btn_defect2 = Radiobutton(vest_donate, text="3 ", value="중", variable=defect_lang_var)
        btn_defect3 = Radiobutton(vest_donate, text="5 ", value="강", variable=defect_lang_var)
