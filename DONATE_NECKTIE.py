...
class Necktie_donate:
    def __init__(self, necktie_donate):
        ...
        btn_defect1 = Radiobutton(necktie_donate, text="1 ", value="약", variable=defect_lang_var)
        btn_defect1.select()  # 기본값 선택
        btn_defect2 = Radiobutton(necktie_donate, text="3 ", value="중", variable=defect_lang_var)
        btn_defect3 = Radiobutton(necktie_donate, text="5 ", value="강", variable=defect_lang_var)
